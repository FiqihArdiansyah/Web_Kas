<?php 
  ...
  if (isset($_POST['btnLaporanPemasukkan'])) {
  	...
  	$sql = mysqli_query($conn, "SELECT * FROM bulan_pembayaran INNER JOIN uang_kas ON bulan_pembayaran.id_bulan_pembayaran = uang_kas.id_bulan_pembayaran INNER JOIN mahasiswa ON uang_kas.id_mahasiswa = mahasiswa.id_mahasiswa WHERE bulan_pembayaran.id_bulan_pembayaran = '$id_bulan_pembayaran'");
