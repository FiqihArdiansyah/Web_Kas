<?php 
  ...
  checkLogin();
  $jml_Mahasiswa = mysqli_fetch_assoc(mysqli_query($conn, "SELECT count(id_Mahasiswa) as jml_Mahasiswa FROM Mahasiswa"));
  $jml_Mahasiswa = $jml_Mahasiswa['jml_Mahasiswa'];
          ...
          <div class="col-lg-3">
            <div class="card shadow">
              <div class="card-body">
                ...
                <h6 class="text-muted">Jumlah Mahasiswa: <?= $jml_Mahasiswa; ?></h6>
                <a href="Mahasiswa.php" class="btn btn-info"><i class="fas fa-fw fa-align-justify"></i></a>
              </div>
            </div>
          </div>
          <div class="col-lg-3">
